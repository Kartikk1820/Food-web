...
//     const recipieIds = req.body.cart;
//     const recipiePromises = recipieIds.map(async (recipieId) => {
//       return Recipie.findById(recipieId);
//     });

//     const recipies = await Promise.all(recipiePromises);

//     console.log(recipies);
//     res.render("cart/cart.ejs", { recipies });
//   });
